...
//    }
    ...
    public List<BudgetEntiteAdministratifItem> findAllBudgetItemNonValider (){
        String requette =  "SELECT beai FROM BudgetEntiteAdministratifItem beai WHERE beai.valider = 0";
        return em.createQuery(requette).getResultList();
    }
}
